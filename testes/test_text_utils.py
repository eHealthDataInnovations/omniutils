...
def test_normalize_str():
    result = TextUtils.normalize_str("Olá Mundo!", special_char="",
                                     space_char="_")
...
def test_extract_numbers_with_keywords():
    ...
    result = TextUtils.extract_numbers_with_keywords(text,
                                                     keywords=["mg", "ml"])
...
def test_extract_content_after_keyword():
    ...
    result = TextUtils.extract_content_after_keyword(
        text, keyword="Valor", stopwords=["da", "caixa"],
...
def test_extract_number_after_keyword():
    result = TextUtils.extract_number_after_keyword("Custo: 1.234,56",
                                                    keyword="Custo")
