...
def dummy_get(url, headers=None, params=None, **kwargs):
    ...
    Ignora os parâmetros extras e retorna uma resposta simulada contendo um commit
    com a data '2024-01-15T12:34:56Z'.
...
def test_get_last_modified_date(monkeypatch):
    ...
    simular a resposta da API do GitHub. Como o método utiliza RequestHandler.request_with_retry,
    aplicamos o patch diretamente nessa função para evitar chamadas reais à API.
